"""
Kennzahlen des ALT-Systems (Tabelle `tickets`, hartcodierte TicketTypes).

Wird mit dem Alt-System ersatzlos entfernt. Die Prozess-Aufträge haben eine
eigene Datei mit eigenem Sammel-Einstieg (`backend/metrics/process_metrics.py`)
und hängen ausdrücklich NICHT mehr an `collect_ticket_metrics`: der Aufruf lief
nur bei gesetztem TICKET_MANAGER und hätte die neuen Reihen beim Rückbau still
mit abgeschaltet.
"""
