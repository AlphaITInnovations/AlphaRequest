...
async def submit_ticket(
    ...
    # 'backoffice' = Legacy-Phasenschlüssel laufender Alt-Onboardings (vor dem P1/P2-Split).
    if tt == TicketType.zugang_beantragen.value and completed_key in ("bearbeitung_sgl", "backoffice"):
