...
from backend.database.tickets import (
    update_ticket,
    get_ticket,
    list_all_tickets
)
from backend.database.groups import get_users_from_group, get_groups, get_group_name_from_id
from backend.models.models import Ticket, TicketType
...
def build_workflow_marketing_stellenanzeige(description: dict) -> dict:
    groups = {g["name"].lower(): g for g in get_groups()}
