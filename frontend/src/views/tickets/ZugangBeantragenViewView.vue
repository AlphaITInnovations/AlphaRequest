...
const a   = (k: string) => data.value?.description?.allgemein?.[k]  ?? '—'
...
const dtv = (k: string) => data.value?.description?.it?.datev?.[k]      ?? '—'
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section class="lg:col-span-2 space-y-5">
          ...
          <div class="bg-white dark:bg-[#212B3A] border border-gray-200/80 dark:border-white/[0.09]
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><p class="ro-label">Eintrittsdatum</p><p class="ro-value">{{ p('start_date') }}</p></div>
                <div class="md:col-span-2">
                  <p class="ro-label">Privatadresse</p>
                  <p class="ro-value whitespace-pre-wrap">{{ p('private_address') }}</p>
                </div>
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div><p class="ro-label">Abteilung</p><p class="ro-value">{{ p('department') }}</p></div>
          ...
          <div class="bg-white dark:bg-[#212B3A] border border-gray-200/80 dark:border-white/[0.09]
            ...
            <h2 class="text-base font-semibold text-[#3EAAB8]">Allgemein</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div><p class="ro-label">Firma (Signatur/Webseite)</p><p class="ro-value">{{ a('appearance_company') }}</p></div>
              <div class="md:col-span-2">
                <p class="ro-label">Adresse (Signatur/Webseite)</p>
                <p class="ro-value whitespace-pre-wrap">{{ a('appearance_address') }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-[#212B3A] border border-gray-200/80 dark:border-white/[0.09]
            ...
            <div>
              <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-3">E-Mail-Signaturdaten</h3>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><p class="ro-label">Handy</p><p class="ro-value">{{ sig('mobile') }}</p></div>
                <div><p class="ro-label">Telefon</p><p class="ro-value">{{ sig('phone') }}</p></div>
              </div>
            </div>

            <div>
              <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-3">DATEV / weitere Systeme</h3>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div><p class="ro-label">DATEV-Anwender?</p><p class="ro-value">{{ dtv('user') }}</p></div>
                <div v-if="dtv('user') === 'Ja'" class="md:col-span-2">
                  <p class="ro-label">DATEV-Rechte</p>
                  <p class="ro-value whitespace-pre-wrap">{{ dtv('required_rights') }}</p>
                </div>
                <div class="md:col-span-2">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                  <p class="ro-label">Zusätzliche Kostenstellen</p>
